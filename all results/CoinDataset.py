...
class CoinDataset(Dataset):
    ...
    def __getitem__(self, idx):
        ...
        text_embedding = torch.tensor(self.embedding[label, :]) # for augment and standard models and mints
        # text_embedding = torch.tensor(self.embedding[idx, np.random.randint(0, 10), :]) # for types
